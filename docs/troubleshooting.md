...
| **El chat responde pero no sale notificación** | No diste permiso, el navegador no soporta notificaciones, o la app estaba cerrada del todo | La notificación es local de navegador, no push con app cerrada. En iPhone funciona mejor instalada como PWA y con permiso concedido al primer envío. Si estás mirando el chat, no se dispara: la respuesta ya está visible |
